...
public class RotationalCipherTest
{
    ...
    [Fact]
    public void RotatePremium_UnRotate_ShouldBeTheSamePassword()
    {
        //given
        string password = "Premium cipher, hold on! 1 8: 5";
        
        //when, then
        string premiumCiphered = RotationalCipher.RotatePremium(password);
        string unciphered = RotationalCipher.UnRotatePremium(premiumCiphered);
        
        Assert.Equal(password, unciphered);
